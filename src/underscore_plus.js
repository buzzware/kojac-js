...
_.zoneless = function(aDate) {
  return new Date(Number(aDate)-(aDate.getTimezoneOffset()*60000));
};

_.toZone = function(aDate) {
  var zone = -(new Date()).getTimezoneOffset();
  return new Date(Number(aDate)-(zone*60000));
};

_.humanize = function(property) {
